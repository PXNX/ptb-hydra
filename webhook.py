...
async def main() -> None:
    ...
    url = "https://ptb-hydra.herokuapp.com"
    ...
    application = (
        ...
        Application.builder().token("5322100822:AAEyYyEa07QD9Q2ybXnooRlDsjXMswZJH3U").updater(None).context_types(context_types).build()
